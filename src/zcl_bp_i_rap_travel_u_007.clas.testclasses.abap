...
CLASS ltcl_integration_test IMPLEMENTATION.
  ...
  METHOD create_travel.
    ...
    DATA travels_in TYPE TABLE FOR CREATE Zbc_I_Rap_Travel_U_007\\Travel.
    ...
    MODIFY ENTITIES OF Zbc_I_Rap_Travel_U_007
        ENTITY travel
  ...
  METHOD class_setup.
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
        i_for_entities = VALUE #( ( i_for_entity = 'Zbc_I_Rap_Travel_U_007' )
                                  ( i_for_entity = 'Zbc_I_Rap_Booking_U_007' ) )
                                ).
  ENDMETHOD.
